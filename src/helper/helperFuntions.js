export default function currentDates() {
  ...
  const currentYear = currentDate.getFullYear(); // Extract current year
  const currentMonth = monthNames.format(currentDate);
  ...
  return { tabLabels, currentMonth, currentYear };
}
